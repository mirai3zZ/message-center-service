...
public class CommonPageParser {
	...
	static{
		try{
			//获取文件模板根路径
			String  templateBasePath =getRootPath();
			templateBasePath = templateBasePath + "resources\\main\\template\\";
	 ...
	 * @param targetFile 生成页面文件路径（相对路径） vowo\index_1.html
	 */
...
//	    	System.out.println("页面生成成功"+file.getAbsolutePath());
	...
	public static String getRootPath(){
		...
		try{
			 ...
			 rootPath = file.getParentFile().getParentFile().getParentFile()+"\\";
